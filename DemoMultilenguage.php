...
echo "LngRad('Es')";
$demo->LngRad('Es');
echo "********** <br> Set my read lenguage <br> ********** <br> <br>";
echo "LngRadMsr('Es')";
$demo->LngRadMsr('Es');
echo "********** <br> Set my wite lenguage ) <br> ********** <br> <br>";
echo "LngWrtMsr('Es')";
$demo->LngWrtMsr('Es');
echo "********** <br>Set defualt write lenguage) <br> ********** <br> <br>";
echo "LngWrtSys('Es')";
$demo->LngWrtSys('Es');
echo "********** <br> Set user read lenguage  <br> ********** <br> <br>";
echo "LngRadUsr('Es','Admin')";
$demo->LngRadUsr('Es','Admin');
echo "********** <br> Set user wite lenguage ) <br> ********** <br> <br>";
